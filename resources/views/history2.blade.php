        ...
        <div class="col-12 col-lg-8 mx-auto"> <!-- Single column container -->
            ...
            <div class="card mb-4">
                 <div class="card-header  text-dark bg-light">
                    <h5 class="mb-0 book-info">Empire of Ashes</h5>
                </div>
                <div class="card-body book-info">
                    <img src="{{asset('images/h2.png')}}" class="book-image" alt="Book Image">
                    <p class="card-text">AD 476. As barbarian hordes sack Rome, General Cassius Vitellius—once the empire's golden commander, now a disgraced gladiator—leads a slave revolt to protect the powerless. With the last emperor fled, Cassius must rally peasants, senators, and former enemies to salvage Rome's soul from the flames. But when the Goth warlord offers him vengeance against the patricians who destroyed his family, Cassius faces an impossible choice: preserve the dying empire, or burn it all down himself.</p>
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Leave a Review for <strong>Empire of Ashes</strong></h5>
                </div>
                <div class="card-body">
                    <!-- Rating Stars -->
                    <div class="mb-3">
