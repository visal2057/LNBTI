        ...
        <div class="col-12 col-lg-8 mx-auto"> <!-- Single column container -->
            ...
            <div class="card mb-4">
                 <div class="card-header  text-dark bg-light">
                    <h5 class="mb-0 book-info">The Siege of Lions</h5>
                </div>
                <div class="card-body book-info">
                    <img src="{{asset('images/h1.png')}}" class="book-image" alt="Book Image">
                    <p class="card-text">1191 AD. Disgraced knight Thomas Beckett defends Jerusalem's last Christian stronghold against Saladin's unstoppable army. As siege towers loom and food runs low, Beckett battles not just Saracen warriors, but his own demons—haunted by the massacre that cost him his honor. When a captured enemy reveals a secret that could save the city, Beckett must choose: obey his fanatical commander's orders to fight to the last man, or forge an unholy alliance that could get him branded a traitor.
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Leave a Review for <strong>The Siege of Lions</strong></h5>
                </div>
                <div class="card-body">
                    <!-- Rating Stars -->
                    <div class="mb-3">
