    ...
    <div class="col-md-4">
      <div class="card card-horizontal">
        ...
        <div class="card-body">
          ...
          <div class="mb-2">
            <label for="quantity-nexus-protocol" class="form-label">Quantity:</label>
            <input type="number" id="quantity-nexus-protocol" name="quantity" value="1" min="1" class="form-control form-control-sm w-50 text-center">
          </div>
    ...
    <div class="col-md-4">
      <div class="card card-horizontal">
        ...
        <div class="card-body">
          ...
          <p class="card-text"><strong>Price: $12.99</strong></p>
          <div class="mb-2">
            <label for="quantity-stars-like-dust" class="form-label">Quantity:</label>
            <input type="number" id="quantity-stars-like-dust" name="quantity" value="1" min="1" class="form-control form-control-sm w-50 text-center">
          </div>
            <div class="d-flex justify-content-end gap-2">
              <a href="#" class="btn btn-outline-primary btn-sm add-to-cart">
                <i class="bi bi-cart"></i> Add to Cart
