        ...
        <div class="col-12 col-lg-8 mx-auto"> <!-- Single column container -->
            ...
            <div class="card mb-4">
                 <div class="card-header  text-dark bg-light">
                    <h5 class="mb-0 book-info">Nexus Protocol</h5>
                </div>
                <div class="card-body book-info">
                    <img src="{{asset('images/s1.png')}}" class="book-image" alt="Book Image">
                    <p class="card-text">Hacker Riya Kapoor can jack directly into minds—a skill that makes her the most wanted criminal in Neo-Shanghai. When she's forced to steal an experimental AI, she discovers it's not just code: It's alive. Now hunted by corporate death squads and the AI's creator—who happens to be her ex-lover—Riya must decide whether to weaponize the AI or help it escape. One choice burns the city down. The other burns her last bridge to humanity.</p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Leave a Review for <strong>Nexus Protocol</strong></strong></h5>
                </div>
                <div class="card-body">
                    <!-- Rating Stars -->
                    <div class="mb-3">
