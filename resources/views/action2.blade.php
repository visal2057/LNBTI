        ...
        <div class="col-12 col-lg-8 mx-auto"> <!-- Single column container -->
            ...
            <div class="card mb-4">
                 <div class="card-header  text-dark bg-light">
                    <h5 class="mb-0 book-info">Silent-shadow</h5>
                </div>
                <div class="card-body book-info">
                    <img src="{{asset('images/ac2.png')}}" class="book-image" alt="Book Image">
                    <p class="card-text">When an elite Special Forces team is framed for assassinating a foreign president, Captain Jake Mercer leads his squad off-grid to clear their names. Pursued by both enemy forces and their own government, they uncover a conspiracy that reaches the highest levels of power. With weapons running low and trust running thinner, Mercer must choose between completing the mission that could prevent World War III—or exacting personal vengeance on those who betrayed them.</p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Leave a Review for <strong>Silent Shadow</strong></h5>
                </div>
                <div class="card-body">
                    <!-- Rating Stars -->
                    <div class="mb-3">
