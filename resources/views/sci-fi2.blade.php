        ...
        <div class="col-12 col-lg-8 mx-auto"> <!-- Single column container -->
            ...
            <div class="card mb-4">
                 <div class="card-header  text-dark bg-light">
                    <h5 class="mb-0 book-info">The Stars Like Dust</h5>
                </div>
                <div class="card-body book-info">
                    <img src="{{asset('images/s2.png')}}" class="book-image" alt="Book Image">
                    <p class="card-text">When salvage crew The Dust Hawks discover a derelict warship carrying both a planet-killing weapon and its creator—a genetically engineered scientist who shouldn't exist—captain Jessa Varo faces an impossible choice: sell the tech to the highest bidder and retire wealthy, or help the scientist destroy it. But the weapon has already awakened, and its true target isn't planets... it's stars.</p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Leave a Review for <strong>The Stars Like Dust</strong></strong></h5>
                </div>
                <div class="card-body">
                    <!-- Rating Stars -->
                    <div class="mb-3">
