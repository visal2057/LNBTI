        ...
        <div class="col-12 col-lg-8 mx-auto"> <!-- Single column container -->
            ...
            <div class="card mb-4">
                 <div class="card-header  text-dark bg-light">
                    <h5 class="mb-0 book-info">Beach Read</h5>
                </div>
                <div class="card-body book-info">
                    <img src="{{asset('images/r1.png')}}" class="book-image" alt="Book Image">
                    <p class="card-text">January Andrews writes fluffy romance. Augustus Everett pens literary tragedies. When these rival authors end up neighboring beach house residents for the summer, they make a bet: She'll try writing something "serious," he'll attempt a happy ending. But as they research each other's genres (romantic sunset dates for her, cemetery visits for him), their icy rivalry thaws into something neither planned—a story neither can control.</p>
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Leave a Review for <strong>Beach Read</strong></h5>
                </div>
                <div class="card-body">
                    <!-- Rating Stars -->
                    <div class="mb-3">
